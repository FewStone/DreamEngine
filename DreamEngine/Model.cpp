...
namespace ModelNS
{
	...
	// load sbm file and feed vertex location attribute used sbm file content
	void Model::LoadSBM(const char * filename)
	{
	...
	void Model::render_sub_object(unsigned int object_index, unsigned int instance_count, unsigned int base_instance)
	{
		glBindVertexArray(vao);
